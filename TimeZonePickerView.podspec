#
#  Be sure to run `pod spec lint Dhamo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Mitesh Soni" => "mitesh_soni@rocketmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "Mitesh Soni" => "Tony Stark" }
  # s.social_media_url   = "http://twitter.com/miteshksoni"
  ...
  s.source       = { :git => "https://github.com/CosmicYogi/TimeZonePickerView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "TimeZonePickerView", "TimeZonePickerView/**/*.{h,m,swift}"
